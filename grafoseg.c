...
grafo_t cargarGrafoDesdeStdin(grafo_t grafo) {
    ...
    */
    ...
    /* 
        ...
        relacion de orden entre ambos. (nombre real ~ etiqueta).
    ...
    */
    ...
    for(int i = 0; i < size_espejo; ++i) {
        ...
        // Vertice nuevo -> agrega a tmp_vertices con grado o valencia = 1.
            ...
            tmp_indice += 1; /* Incrementa el indice y agrego el vertice. */
            ...
            printf("Grado nuevo para vertice %u\n", tmp_vertices[tmp_indice]->nombre);
        }
...
int main(void){
	...
	printf("N Y M son %u y %u\n", grafo->n_vertices, grafo->m_lados);
	return(0);
}
